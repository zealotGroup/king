<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-input @keyup.enter.native="search" style="width: 200px;" class="filter-item" v-model="table.query.phoneNumber" :placeholder="$t('phoneNumber')">
      </el-input>
      <el-input @keyup.enter.native="search" style="width: 200px;" class="filter-item" v-model="table.query.address" :placeholder="$t('address')">
      </el-input>
    </div>
    <div class="filter-container">
    ...
    <el-table :key='table.key' :data="table.list" v-loading="table.loading" border fit highlight-current-row
      ...
      <el-table-column min-width="100px" :label="$t('phoneNumber')">
        <template slot-scope="scope">
          <span>{{scope.row.phoneNumber }}</span>
        </template>
      </el-table-column>
      <el-table-column min-width="100px" :label="$t('address')">
        <template slot-scope="scope">
...
<script>
  import { getList, get, add, update, del } from '@/api/jxc/supplier'
